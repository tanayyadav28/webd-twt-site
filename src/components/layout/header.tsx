...
export default function Header() {
  return (
    <header className="bg-gray-900 flex items-center justify-between px-8 shadow-md">
      {/* LEFT SIDE: Logo or Site Name */}
      <div className="flex items-center space-x-2">
        {/* Logo (optional, replace /logo.png with your file in public folder) */}
        <Image src="/images/twt_logo.png" alt="Logo" width={100} height={60} />
      </div>
      ...
      <nav className="hidden md:flex space-x-6">
        ...
        <Link href="/services" className="text-gray-300 hover:text-purple-600">Services</Link>
        <Link href="/about" className="text-gray-300 hover:text-purple-600">About</Link>
